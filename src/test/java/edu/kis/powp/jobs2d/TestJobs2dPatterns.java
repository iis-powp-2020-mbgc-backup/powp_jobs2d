...
public class TestJobs2dPatterns {
	...
	private static void setupPresetTests(Application application) {
		application.addTest("Figure Joe 1", new SelectTestFigureOptionListener(
				DriverFeature.getDriverManager(), DrawingType.FIGURE_1));
		application.addTest("Figure Joe 2", new SelectTestFigureOptionListener(
				DriverFeature.getDriverManager(), DrawingType.FIGURE_2));
		application.addTest("Figure Jane", new SelectTestFigureOptionListener(
				DriverFeature.getDriverManager(), DrawingType.FIGURE_JANE));
		application.addTest("Figure Test", new SelectTestFigureOptionListener(
				DriverFeature.getDriverManager(), DrawingType.FIGURE_TEST));
		application.addTest("Figure Test 2", new SelectTestFigureOptionListener(
				DriverFeature.getDriverManager(), DrawingType.FIGURE_TEST2));
	}
