...
import edu.kis.powp.jobs2d.drivers.adapter.PatternDrawerAdapter;
...
public class TestJobs2dPatterns {
	...
	private static void setupPresetTests(Application application) {
		SelectTestFigureOptionListener selectTestFigureOptionListener1 = new SelectTestFigureOptionListener(
				DriverFeature.getDriverManager(), ScriptType.FIGURE_JOE_1);

		SelectTestFigureOptionListener selectTestFigureOptionListener2 = new SelectTestFigureOptionListener(
				DriverFeature.getDriverManager(), ScriptType.FIGURE_JOE_2);
		...
		application.addTest("Triangle", actionEvent -> FiguresFactory.Trangle(DriverFeature.getDriverManager().getCurrentDriver()).execute());
	}
	...
	private static void setupDrivers(Application application) {
		...
		Job2dDriver testDriver = new PatternDrawerAdapter(DrawerFeature.getDrawerController());
		...
		DriverFeature.addDriver("Special lines Simulator", specialLineDriver);

		Job2dDriver dottedLineDriver = new LineDrawerAdapter(DrawerFeature.getDrawerController(), LineFactory.getDottedLine());
		DriverFeature.addDriver("Dotted lines Simulator", dottedLineDriver);
