...
public class TestJobs2dPatterns {
	...
	private static void setupPresetTests(Application application) {
		...
		application.addTest("Rectangle", e -> CommandFactory.drawRectangle(DriverFeature.getDriverManager().getCurrentDriver()));
		application.addTest("Square", e -> CommandFactory.drawSquare(DriverFeature.getDriverManager().getCurrentDriver()));
		application.addTest("Triangle", e -> CommandFactory.drawTriangle(DriverFeature.getDriverManager().getCurrentDriver()));
	}
