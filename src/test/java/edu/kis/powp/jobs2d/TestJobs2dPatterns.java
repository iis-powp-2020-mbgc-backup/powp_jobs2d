...
public class TestJobs2dPatterns {
	...
	private static void setupDrivers(Application application) {
		...
		Job2dDriver testDriver = new DrawLineAdapter(DrawerFeature.getDrawerController());
		DriverFeature.addDriver("Buggy Simulator", testDriver);

		Job2dDriver testDriverDottedLine = new LineDrawerAdapter(LineFactory.getDottedLine());
		DriverFeature.addDriver("Dotted Line", testDriverDottedLine);

		Job2dDriver testDriverSpecialLine = new LineDrawerAdapter(LineFactory.getSpecialLine());
		DriverFeature.addDriver("Special Line", testDriverSpecialLine);
